...
public class Competition extends BaseActivity {
    ...
    private String TAG = Competition.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_competition, null, false);
        drawer.addView(contentView, 0);
        contactList = new ArrayList<>();

        lv = (ListView) findViewById(R.id.competition);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            Httpforcompetition sh = new Httpforcompetition(getApplicationContext());
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        String name = c.getString("bc_address");
                        String email = c.getString("bc_belt_level");
                        String edate = c.getString("bc_date");
                        String org = c.getString("bc_organizeby");
                        String note = c.getString("bc_note");
                ...
                builder.setMessage("No event for current time")
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent = new Intent(Competition.this,UpcomingEvents.class);
