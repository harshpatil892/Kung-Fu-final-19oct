...
public class Httpforgradingresult {

    private static final String TAG = Httpforgradingresult.class.getSimpleName();
    ...
    public Httpforgradingresult(Context context){
    ...
    public String makeServiceCall(String reqUrl) {
        ...
        try {
            URL url = new URL("http://10.0.43.1/kungfu2/api/v1/user.php?data=belt_exam_result");
