...
public class CampFragment extends Fragment {
  ...
  private ListView lv;
  private static String url = "http://10.0.43.1/kungfu2/api/v1/user.php?data=train_camp_result";
  ArrayList<HashMap<String, String>> contactList;

  public CampFragment(Context context) {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View v =inflater.inflate(R.layout.fragment_camp,container,false);
...
//            getUserId(this);
    ...
    protected Void doInBackground(Void... arg0) {
      Httpforcampresult hp = new Httpforcampresult(getActivity());
