...
public class Httpforindividualnoti {

    private static final String TAG = Httpforindividualnoti.class.getSimpleName();
    ...
    public Httpforindividualnoti(Context context){
