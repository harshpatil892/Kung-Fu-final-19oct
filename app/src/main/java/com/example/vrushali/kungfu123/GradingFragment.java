...
public class GradingFragment extends Fragment {
  ...
  private ListView lv;
  private static String url = "http://10.0.43.1/kungfu2/api/v1/user.php?data=belt_exam_result";
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View v =inflater.inflate(R.layout.fragment_grading,container,false);
...
//      pDialog.show();
    ...
    protected Void doInBackground(Void... arg0) {
      Httpforgradingresult hp = new Httpforgradingresult(getActivity());
      ...
      if (jsonStr != null) {
        try {
          ...
          for (int i = 0; i < contacts.length(); i++) {
            ...
            String name = c.getString("be_reg_date");
            String email = c.getString("be_reg_result");
