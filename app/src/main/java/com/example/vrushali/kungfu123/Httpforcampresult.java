...
public class Httpforcampresult {

    private static final String TAG = Httpforcampresult.class.getSimpleName();
    ...
    public Httpforcampresult(Context context) {
    ...
    public String makeServiceCall(String reqUrl) {
        ...
        try {
            URL url = new URL("http://10.0.43.1/kungfu2/api/v1/user.php?data=train_camp_result");
